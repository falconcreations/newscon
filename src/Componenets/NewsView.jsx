                            ...
                            <div id="nv-main" className="container news_detail">
                                 ...
                                 {sponsoredads ? (
                                    <div className="ad_spaces">
                                        <div target="_blank" onClick={() => window.open(sponsoredads.ad_spaces_top.ad_url, '_blank')}>
                                            {<img className="adimage" src={sponsoredads.ad_spaces_top.web_ad_image} alt="ads" />}
                                        </div>
                                    </div>
                                ) : null}
                                {/* tags */}
                                {Data[0].tag_name ? (
                                    <span className="tags_section">
                                        ...
                                        <p
                                            ...
                                            onClick={() => navigate("/tag-news-view?Tid=" + Data[0].tag_id)}
                                        >
                                            {tag}
                                        </p>
                                        ))}
                            ...
                            <div id="nv-page" className="row">
                                <div id="nv-body" className="col-lg-8 col-12">
                                    ...
                                    <div id="nv-right-section" className="col-lg-4 col-12">
                                        {catid ?
                                            <RelatedNewsSection Cid={catid} Nid={Nid}/> : null
                                    }
                                    <TagsSection />
                                </div>
                            </div>
                            ...
                            <SignInModal setIsLogout={setIsLogout} setisloginloading={setisloginloading} show={modalShow} setLoginModalShow={setModalShow} onHide={() => setModalShow(false)} />
                                ...
                                {sponsoredads ? (
                                    <div className="ad_spaces my-3">
                                        <div target="_blank" onClick={() => window.open(sponsoredads.ad_spaces_bottom.ad_url, '_blank')}>
                                            {<img className="adimage" src={sponsoredads.ad_spaces_bottom.web_ad_image} alt="ads" />}
                                        </div>
                                    </div>
                                ) : null}
                            </div>
