                    ...
                    <div className='my-3'>
                        {isLoading ? (
                            ...
                            Data.map((element, index) => (
                                <Link className={`card my-3${element.category_id === "0" ? " disabled-link" : ""}`} key={index} to={element.category_id !== "0" ? `/news-view?Nid=${element.news_id}&Cid=${element.category_id}` : null}>
                                    <div className="card-body bd-highlight" id='card-noti'>
                                        ...
                                        <div className='Noti-text'>
                                            ...
                                            <p className='bd-highlight bd-title message-title'>{truncateText(element.message,100)}</p>
