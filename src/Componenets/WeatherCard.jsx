...
function WeatherCard() {
    ...
    // address
    const addressReturn = (type) => {
        const locality = location && location.address_components.find(item => item.types.includes(`${type}`));

        const localityShortName = locality && locality.long_name;
                                   ...
                                   {location && (
                                    <>
                                        ...
                                        <p className="location-wcard mb-0 ">
                                            {addressReturn("locality")},{addressReturn("administrative_area_level_1")},{addressReturn("country")}
                                        </p>
