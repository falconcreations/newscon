                    ...
                    <div className="navbar_content">
                        ...
                        <div className="Manu-links">
                            <ul className="">
                                ...
                                </li>                                <li id="Nav-btns" className="d-flex">
                        ...
                        <div className="hamburger-manu">
                            {["end"].map((placement, idx) => (
                                <MobilesideBar key={idx} languageChange={languageChange } placement={placement} name={placement} logout={logout} onClickHandler={onClickHandler} Data={Data} modalShow={modalShow} setModalShow={setModalShow} islogout={islogout} setIsLogout={setIsLogout} handleShow={handleShow} show={show} handleClose={handleClose } />
                            ))}
                        </div>
                    </div>
                </div>
