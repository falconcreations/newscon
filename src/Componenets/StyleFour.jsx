                    ...
                    <div className="container">
                        <div className="row">
                                ...
                                <div id="rns-head-main" className="">
                                        ...
                                        <Link href="/" id="rns-Viewmore" to={`/video-news-view?id=${Data.id}&name=${Data.title}`} onClick={() => scrollToTop()}>
                                            {translate("viewMore")}
                                        </Link>
                                    </div>
                    ...
                    <div className="container">
                        <div className="row">
                                ...
                                <div id="rns-head-main" className="">
                                        ...
                                        <Link href="/" id="rns-Viewmore" to={`/view-all?id=${Data.id}&name=${Data.title}`} onClick={() => scrollToTop()}>
                                            {translate("viewMore")}
                                        </Link>
                                    </div>
                                    ...
                                    <div className="row">
                                        {Data.news.map((value, index) => {
                                            return (
                                                <div className="col-lg-4 col-md-4 col-sm-6 col-12">
                                                    <Link id="rns-card" className="card card_hover_two" key={index} to={"/news-view?Nid=" + value.id + "&Cid=" + value.category_id}>
                                                        <div className="banner_thumb">
                                                            <img id="rns-image" src={value.image} className="card-img-top" alt="news" onError={placeholderImage}/>
                                                        </div>
                                                        <div id="rns-img-overlay" className=" card-inverse">
                                ...
                                <div id="rns-cards-main" className="">
                                    ...
                                    <div className="row">
                                        {Data.breaking_news.map((value, index) => {
                                            return (
                                                <div className="col-lg-4 col-md-4 col-sm-6 col-12">
                                                    <Link id="rns-card" className="card card_hover_two" key={index} to={"/breaking-news?BNid=" + value.id}>
                                                    <div className="banner_thumb">
                                                            <img id="rns-image" src={value.image} className="card-img-top" alt="news" onError={placeholderImage}/>
                                                        </div>
                                                        <div id="rns-card-body" className="card-block">
                                                            <p className="card-title">{value.title}</p>
                                                            <Link id="btnrnsRead" className="btn overlay" to={"/breaking-news?BNid=" + value.id} type="button">
                                                            {translate("readmore")}
                                                                <HiOutlineArrowLongRight id="rns-arrow" size={20} />
                                                            </Link>
                                                        </div>
