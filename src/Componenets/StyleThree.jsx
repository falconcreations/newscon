                    ...
                    <div className="container">
                        <div className="row">
                            <div id="vps-head-main" className="">
                                ...
                                <Link href="/" id="vps-Viewmore" onClick={() => scrollToTop()} to={`/video-news-view?id=${Data.id}&name=${Data.title}`}>
                                    {translate("viewMore")}
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div id="vps-head-main" className="">
                                ...
                                <Link href="/" id="vps-Viewmore" onClick={() => scrollToTop()} to={`/view-all?id=${Data.id}&name=${Data.title}`}>
                                    {translate("viewMore")}
                                </Link>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-lg-6 col-12">
                                <div id="vps-body-left">
                                    {Data.news[0] ? (
                                        <Link to={"/news-view?Nid=" + Data.news[0].id + "&Cid=" + Data.news[0].category_id}>
                                            <Card id="vps-main-card" className="text-black">
                            ...
                            <div className="col-lg-6 col-12">
                                <div id="vps-body-right">
                                    {Data.news[1] ? (
                                        <Link to={"/news-view?Nid=" + Data.news[1].id + "&Cid=" + Data.news[1].category_id}>
                                    ...
                                    {Data.news[2] ? (
                                         <Link to={"/news-view?Nid=" + Data.news[2].id + "&Cid=" + Data.news[2].category_id}>
                            ...
                            <div className="col-lg-6 col-12">
                                <div id="vps-body-left">
                                    {Data.breaking_news[0] ? (
                                        <Link to={"/breaking-news?BNid=" + Data.breaking_news[0].id}>
                                            <Card id="vps-main-card" className="text-black">
                            ...
                            <div className="col-lg-6 col-12">
                                <div id="vps-body-right">
                                    {Data.breaking_news[1] ? (
                                        <Link to={"/breaking-news?BNid=" + Data.breaking_news[1].id}>
                                            <Card id="vps-image-cards" className="text-black second_video">
                                    ...
                                    {Data.breaking_news[2] ? (
                                        <Link to={"/breaking-news?BNid=" + Data.breaking_news[2].id}>
                                            <Card id="vps-image-cards" className="text-black third_video">
