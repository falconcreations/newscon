                                ...
                                <div className="col-md-6 col-lg-4 col-12" key={element.id}>
                                    <div id="bs-card" className="card">
                                        <div className="bs_image_card">
                                            <img id="bs-card-image" src={element.image} className="card-img" alt="..." onClick={() => navigate("/news-view?Nid=" + element.news_id + "&Cid=" + element.category_id)} />
                                        ...
                                        <div id="bs-card-body" className="card-body">
                                            <button id="bs-btnCatagory" className="btn btn-sm" type="button" onClick={() => navigate("/news-view?Nid=" + element.news_id + "&Cid=" + element.category_id)}>
                                                {element.category_name}
                                            </button>
                                            <h5 id="bs-card-title" className="card-title" onClick={() => navigate("/news-view?Nid=" + element.news_id + "&Cid=" + element.category_id)}>
                                                {element.title}
                                            </h5>
                                            <p id="bs-card-date">
