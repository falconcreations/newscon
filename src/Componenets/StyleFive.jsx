                            ...
                            <div className="col-md-4 col-12">
                                <div id="bns-main-card" className="card">
                                    ...
                                    <div id="bns-main-text" className="card-img-overlay">
                                        ...
                                        <Link id="btnbnsViewAll" className="btn" type="button" to={`/video-news-view?id=${Data.id}&name=${Data.title}`} onClick={() => scrollToTop()}>
                                            {translate("viewall")}
                                        </Link>
                                    </div>
                                </div>
                            ...
                            <div className="col-md-4 col-12">
                                <div id="bns-main-card" className="card">
                                    ...
                                    <div id="bns-main-text" className="card-img-overlay">
                                        ...
                                        <Link id="btnbnsViewAll" className="btn" type="button" to={`/view-all?id=${Data.id}&name=${Data.title}`} onClick={() => scrollToTop()}>
                                            {translate("viewall")}
                                        </Link>
                                    </div>
                                </div>
                                                ...
                                                <SwiperSlide key={element.id}>
                                                    <div id="bns-card" className="card" key={element.id}>
                                                        <Link id="Link-all" to={"/news-view?Nid=" + element.id + "&Cid=" + element.category_id}>
                                                            <img id="bns-image" src={element.image} className="card-img-top" alt="news" onError={placeholderImage}/>
                                                            <div id="bns-card-body" className="card-body ps-0">
                                                                <Link id="btnbnsCatagory" className="btn btn-sm" type="button" to={"/news-view?Nid=" + element.id + "&Cid=" + element.category_id}>
