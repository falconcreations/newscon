                    ...
                    <div className="container">
                        ...
                        <div id="hns-head" className="row mb-3">
                            <div id="hns-head-main">
                                ...
                                <Link href="/" id="hns-Viewmore" to={`/video-news-view?id=${Data.id}&name=${Data.title}`} onClick={() => scrollToTop()}>
                                    {translate("viewMore")}
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="container">
                        ...
                        <div id="hns-head" className="row mb-3">
                            <div id="hns-head-main">
                                ...
                                <Link href="/" id="hns-Viewmore" to={`/view-all?id=${Data.id}&name=${Data.title}`} onClick={() => scrollToTop()}>
                                    {translate("viewMore")}
                                </Link>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-md-3">
                                {Data.news[0] ? (
                                    <div className="video_first_top card card_hover" onClick={() => navigate("/news-view?Nid=" + Data.news[0].id + "&Cid=" + Data.news[0].category_id)}>
                                ...
                                {Data.news[1] ? (
                                    <div className="video_seond_top card card_hover" onClick={() => navigate("/news-view?Nid=" + Data.news[1].id + "&Cid=" + Data.news[1].category_id)}>
                            ...
                            <div className="col-md-6">
                                {Data.news[2] ? (
                                    <div className="video_center card card_hover" onClick={() => navigate("/news-view?Nid=" + Data.news[2].id + "&Cid=" + Data.news[2].category_id)}>
                            ...
                            <div className="col-md-3">
                                {Data.news[3] ? (
                                    <div className="video_top_right card card_hover" onClick={() => navigate("/news-view?Nid=" + Data.news[3].id + "&Cid=" + Data.news[3].category_id)}>
                                ...
                                {Data.news[4] ? (
                                    <div className="video_bottom_right card card_hover" onClick={() => navigate("/news-view?Nid=" + Data.news[4].id + "&Cid=" + Data.news[4].category_id)}>
                        ...
                        <div className="row">
                            <div className="col-md-3">
                                {Data.breaking_news[0] ? (
                                    <div className="video_first_top card card_hover" onClick={() => navigate("/breaking-news?BNid=" + Data.breaking_news[0].id)}>
                                ...
                                {Data.breaking_news[1] ? (
                                    <div className="video_seond_top card card_hover" onClick={() => navigate("/breaking-news?BNid=" + Data.breaking_news[1].id)}>
                            ...
                            <div className="col-md-6">
                                {Data.breaking_news[2] ? (
                                    <div className="video_center card card_hover" onClick={() => navigate("/breaking-news?BNid=" + Data.breaking_news[2].id)}>
                            ...
                            <div className="col-md-3">
                                {Data.breaking_news[3] ? (
                                    <div className="video_top_right card card_hover" onClick={() => navigate("/breaking-news?BNid=" + Data.breaking_news[3].id)}>
                                ...
                                {Data.breaking_news[4] ? (
                                    <div className="video_bottom_right card card_hover" onClick={() => navigate("/breaking-news?BNid=" + Data.breaking_news[4].id)}>
